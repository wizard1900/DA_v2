...
new (accordion_js__WEBPACK_IMPORTED_MODULE_0___default())('.accordion-container');
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Scrollbar, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination]);
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.comments__swiper', {
  pagination: {
...
if (form) {
  ...
  const validation = new just_validate__WEBPACK_IMPORTED_MODULE_0__["default"]('.graph-modal__form');
  validation.addField('input[name="name"]', [{
    rule: 'minLength',
    value: 3,
